...
// componentDidMount component render olduktan sonra çalışacak şekilde yazmak istiyorsak aşağıdaki şekilde ikinci
useEffect(()=>
{
  loginOrLogout();
...
const loginOrLogout=() =>{
  ...
  return (
    ...
    <Navigation isLogin={isLogin} loginOrLogout={loginOrLogout} />
    <Switch>
      ...
      <Route path='/blog-ekle'> <AddBlog /></Route>
